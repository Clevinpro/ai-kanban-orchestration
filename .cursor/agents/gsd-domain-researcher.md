...
<required_reading>
Read `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
