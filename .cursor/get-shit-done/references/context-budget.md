...
The keys live in `.claude/settings.json` (project) or `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
