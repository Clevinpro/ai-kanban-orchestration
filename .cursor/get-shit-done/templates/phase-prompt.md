...
<!-- For checkpoint task examples and patterns, see @/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/checkpoints.md -->
...
See `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
