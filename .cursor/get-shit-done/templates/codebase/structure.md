...
- Usage: Reference from command with `@/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
