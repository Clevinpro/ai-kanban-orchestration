...
<required_reading>
@/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/ai-frameworks.md
@/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-eval-planner.md for instructions.
