...
Key references:
- @/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md" "/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/.cursor/rules/
```
