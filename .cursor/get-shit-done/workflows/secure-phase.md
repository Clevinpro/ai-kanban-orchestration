...
```
Agent(
  prompt="Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/get-shit-done/templates/SECURITY.md`
