...
- **Global scope**: `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/notes/`)
...
2. Glob `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tarasbannyi/TestAI/ai-agent-microservices/.cursor/notes/` — works in any directory
