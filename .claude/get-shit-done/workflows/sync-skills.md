...
INSTALL_JS_GLOBAL="/Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
