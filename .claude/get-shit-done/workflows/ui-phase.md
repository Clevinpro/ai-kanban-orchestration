...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/agents/gsd-ui-checker.md for instructions.
