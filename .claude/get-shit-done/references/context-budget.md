...
The keys live in `.claude/settings.json` (project) or `/Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/settings.json` (global) — **not** in `.planning/config.json`:
