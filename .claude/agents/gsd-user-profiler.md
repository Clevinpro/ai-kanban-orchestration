...
<reference>
@/Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/tarasbannyi/TestAI/ai-agent-microservices/.claude/get-shit-done/references/user-profiling.md` to load:
